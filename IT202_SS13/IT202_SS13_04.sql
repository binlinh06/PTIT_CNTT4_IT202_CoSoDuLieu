...
/* =========================================
   3. TRIGGER BEFORE UPDATE ON posts
   Lưu lịch sử khi content thay đổi
========================================= */
DELIMITER //
...
/* =========================================
   4. TRIGGER AFTER DELETE ON posts
   (CASCADE đã tự xóa history & likes)
========================================= */
DELIMITER //
...
/* =========================================
   8. KIỂM TRA VIEW user_statistics (BÀI 2)
========================================= */
